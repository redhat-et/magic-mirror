...
import (
	...
	"github.com/redhat-et/magic-mirror/controllers"
...
func init() {
	...
	utilruntime.Must(imagesetConfig.AddToScheme(scheme))
	utilruntime.Must(mirroropenshiftiov1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "68655c98.mirror.openshift.io",
	...
	if err = (&controllers.ImportReconciler{
